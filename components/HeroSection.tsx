                ...
                <FadeIn key={highlight.title} delay={index * 150} className="h-full">
                  <div
                    className="
                      ...
                      hover:bg-white/95 
                      hover:shadow-[0_20px_50px_-12px_rgba(14,165,233,0.3)] 
                      hover:-translate-y-1
                    "
                  >
                    {/* ICON */}
                    ...
                    <div className="flex flex-col flex-1 w-11/12 mx-auto items-center">
                      {/* 修改重點：
                          將 items-center 改為 items-start。
                          這樣所有標題都會固定在容器的「最上方」開始，
                          不會因為行數不同而導致垂直位置不一。
                      */}
                      <h3 className="
                        font-bold leading-tight text-center text-base sm:text-lg text-slate-900 
                        mb-3 min-h-[3.5rem] flex items-start justify-center
                      ">
                        {highlight.title}
                      </h3>
