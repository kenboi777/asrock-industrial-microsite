...
<div className="text-center mb-12 lg:mb-16">
  ...
  <p
    className="text-lg text-[hsl(var(--muted-foreground))] max-w-4xl mx-auto"
    style={{
      textAlign: 'justify',
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
                      ...
                      <div className="flex flex-col rounded-2xl shadow-xl overflow-hidden h-full bg-gray-100">
                        ...
                        <div className="px-4 py-4 lg:px-5 lg:py-5 bg-slate-100">
                          <p
                            className="mt-1 text-base text-slate-700 leading-relaxed text-justify"
                            style={{ textAlignLast: 'left' as any }}
                          >
                            <span className="font-bold">AiSafeguard</span> secures OT
                            devices using Zero Trust and containerized architecture,
                            enabling isolation, monitoring, and resilient governance.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col rounded-2xl shadow-xl overflow-hidden h-full bg-gray-100">
                        ...
                        <div className="px-4 py-4 lg:px-5 lg:py-5 bg-slate-100">
                          <p
                            ...
                            style={{ textAlignLast: 'left' as any }}
                          >
                            <span className="font-bold">AiSMA</span> integrates the
                            Redfish standard for secure, cryptographically hardened
                            out-of-band (OOB) remote management across distributed
                          ...
                          <div className="rounded-2xl bg-white shadow-xl overflow-hidden flex flex-col h-full">
                            ...
                            <div className="px-6 py-6 bg-slate-100">
                              <p
                                ...
                                style={{ textAlignLast: 'left' as any }}
                              >
                                <span className="font-bold">Ai FDO</span> provides
                                zero-touch, automated, and highly secure onboarding
                                solution based on the FIDO Alliance industry standard.
                              </p>
                            </div>
                          </div>
                        ) : (
                      ...
                      <div className="flex flex-row lg:flex-col items-center lg:items-center h-full">
                        ...
                        <div className="flex flex-col flex-1 w-full">
                          ...
                          <p
                            ...
                            style={{ textAlignLast: 'left' as any }}
                          >
                            Secure boot and platform attestation, with technologies like
                            TPM and hardware-based safeguards, establish a
                            hardware-rooted chain of trust to ensure systems start clean
                            and remain tamper-resistant.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-row lg:flex-col items-center lg:items-center h-full">
                        ...
                        <div className="flex flex-col flex-1 w-full">
                          ...
                          >
                            ...
                            attack surfaces and protecting data in multi-tenant
                            environments, ensuring secure resource separation.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-row lg:flex-col items-center lg:items-center h-full">
                        ...
                        <div className="flex flex-col flex-1 w-full">
                          ...
                          <p
                            ...
                            style={{ textAlignLast: 'left' as any }}
                          >
                            Advanced encryption, access controls, and side-channel
                            defenses to safeguard memory, code integrity, and sensitive
                      ...
                      <div className="flex flex-row lg:flex-col items-center lg:items-center h-full">
                        ...
                        <div className="flex flex-col flex-1 w-full">
                          ...
                          >
                            ...
                            randomness, and protect stored data with efficient,
